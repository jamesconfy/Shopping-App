...
def home():
    ...
    return jsonify(data=listOfProduct), 200
...
def registerConsumer():
    ...
    if request.method == 'POST':
        ...
        consumer = Consumer(username=username, email=email, password=hashed_password, address=address, phoneNumber=phoneNumber, firstName=firstName, lastName=lastName)
